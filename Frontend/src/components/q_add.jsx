          ...
          {!errSize ? (
              ...
              <div>
                {errQuestion ? (
                  <p className="error_q_add">
                    <i className="fa-solid fa-exclamation"></i> Fill the
                    question
                  </p>
                ) : (
                  ""
                ...
                {errAns1 ? (
                  <p className="error_q_add">
                    <i className="fa-solid fa-exclamation"></i> Fill Option: 1
                  </p>
                ) : (
                  ""
                )}
                {errAns2 ? (
                  <p className="error_q_add">
                    <i className="fa-solid fa-exclamation"></i> Fill Option: 2
                  </p>
                ) : (
                  ""
                )}
                {errAns3 ? (
                  <p className="error_q_add">
                    <i className="fa-solid fa-exclamation"></i> Fill Option: 3
                  </p>
                ) : (
                  ""
                )}
                {errAns4 ? (
                  <p className="error_q_add">
                    <i className="fa-solid fa-exclamation"></i> Fill Option: 4
                  </p>
                ) : (
                  ""
                )}
            ...
            <div className="publish_body container">
              <button className="done-btn btn btn-success" onClick={onPublish}>
                <i className="fa-regular fa-circle-check"></i> Publish
              </button>
            </div>
          )}
        </form>
